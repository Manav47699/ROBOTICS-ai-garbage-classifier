...
while True:
    ...
    # Show hand landmarks even if not used for logic
...
# Run YOLO detection to check for 'plastic'
if len(detections) > 0:
...
# Final frame with optional hand display
...
# Determine final prediction (ignore hand count)
predicted_class = "plastic" if plastic_detected else "paper"
...
try:
    ...
    print(f"✅ Sent prediction '{predicted_class}' to COM1")
    ser.close()
